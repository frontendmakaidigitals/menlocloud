    ...
    <>
      <main className='main-wrapper relative overflow-hidden'>
        ...
        <section id='hero-section'>
          <div className='relative z-[1] overflow-hidden text-center text-slate-100'>
            {/* Section Spacer */}
            <div className="bg-[url('/assets/img_placeholder/th-4/hero-bg.jpg')] bg-cover bg-no-repeat pb-20 pt-28 md:pb-[265px] md:pt-40 lg:pt-44 xl:pt-[226px]">
              {/* Section Container */}
              <div className='global-container'>
                <h1 className='jos mb-6 font-spaceGrotesk leading-none -tracking-[2px] text-gray-100'>
