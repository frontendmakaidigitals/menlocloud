  ...
  return (
    <header
      ...
      className={`w-full site-header z-[999] transition-all duration-300 fixed ${
        !isVisible ? "!bg-black py-2  " : "py-3 bg-transparent"
      }  `}
    >
      <div className="global-container">
        <div className="flex items-center justify-between gap-x-8">
          ...
          <div className="flex items-center gap-6">
            <div
              className={cn(
                "group rounded-full hidden xl:text-md xxl:text-lg lg:block border relative overflow-hidden border-black/5 bg-neutral-100 text-base text-white transition-all ease-in hover:cursor-pointer hover:bg-neutral-200  "
              )}
            >
